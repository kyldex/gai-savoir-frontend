    ...
    <div className={styles.container}>
      <Head>
        ...
        <SocialMediaMetaTags
          ...
          url={`${process.env.NEXT_PUBLIC_WEBSITE_URL}/articles/societe/${article.attributes.slug}`}
        />
      </Head>
...
export const getStaticPaths: GetStaticPaths = async () => {
  const res = await fetch(`${process.env.NEXT_PUBLIC_STRAPI_API_URL}/ideas?filters[$and][0][subcategory][name][$eq]=Société`);
