...
const eventsData: EventData = [
  {
    ...
    attributes: {
      ...
      excerpt: 'Le 15 février 2023 au Point Éphémère',
      published: '2023-04-20',
      content: [
        "Lancement officiel du Gai Savoir, ce 1er évènement sur l'amour se structurait autour d'une table ronde d'1h, suivie d'une prestation live de l'EP 'Ruptures Futures' de Bolides Boys et d'un DJ set assuré par l'artiste Bolivard. ",
      ...
      card_image: {
        data: {
          attributes: {
            url: 'https://res.cloudinary.com/dhj1ij2pz/image/upload/v1685115590/event-gai-savoir-amour_lqr9i3.jpg'
          }
        }
      },
